...
export const LogoutModalHTML = `<div id="logoutConfirmModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-sm p-6">
        <h3 class="text-lg font-semibold mb-4">Confirmação de Logout</h3>
        <p class="mb-6">Deseja realmente sair da conta?</p>
        <div class="flex justify-end gap-3">
            <button id="cancelLogout" class="px-4 py-2 border rounded small-muted hover:bg-gray-100">
                Cancelar
            </button>
            <button id="confirmLogout" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">
                Sair
            </button>
        </div>
    </div>
